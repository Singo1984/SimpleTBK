...
chrome.runtime.sendMessage({method: "getServerIP"}, function(serverIP) {
    Rebate = {
        start: function() {
            ...
            $.ajax({
                url: "http://" + serverIP + "/tbk?item_id=" + item_id,
                type: "get",
                ...
                error: function () {
                    chrome.runtime.sendMessage({method: "serverError"});
                }
            });
        },
